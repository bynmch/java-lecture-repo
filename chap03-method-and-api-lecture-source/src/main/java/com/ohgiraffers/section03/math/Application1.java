...
public class Application1 {
    public static void main(String[] args) {
        ...
        /* 수업목표. math에서 제공하는 static메소드를 호출할 수 있다.  */
        /* 설명.
         *  java.lang패키지에서 제공되는 클래스는 풀글래스명(패키지 포함)이나
...
/* 필기.
 *  Math클래스는 왜 줄여서 쓸 수 있는가.
 *  Math클래스에서 제공되는 것은 static 메소드
 *  java.lang 패키지에 있으면 생략 가능.
 *   */
