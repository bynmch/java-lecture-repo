...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        /* 설명.
         *  문자열을 특정 구분자로 하여 분리한 문자열을 반환하는 두 가지 방법
        ...
        * */
        ...
        String[] empArr1 = emp1.split("/"); // [/?]: 구분자가 여러 개일 경우
        String[] empArr2 = emp2.split("/"); // [/?]: 구분자가 여러 개일 경우
        String[] empArr3 = emp3.split("/"); // [/?]: 구분자가 여러 개일 경우
        ...
        String colors = "red, yellow, green, blue, purple? blue";
        StringTokenizer colorStringTokenizer = new StringTokenizer(colors, ", ?");
        while(colorStringTokenizer.hasMoreTokens()) {

            /* 설명. nextToken()은 단순히 다음 값을 뽑을 뿐 아니라 그 다음칸으로 넘어감을 인지하고
             *      여러 번 활용하고 싶으면 변수에 담아서 활용할 것
            * */
