...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        /* 설명. 2. LongStream */
        System.out.println("1부터 10만까지의 짝수의 합 계산");
        ...
        /* 설명. 4. 박싱(Boxing): 기본 타입을 래퍼 클래스로 변환(Stream에서는 제네릭이 걸린 Stream 또는 컬렉션 활용 시 박싱 유의) */
        Stream<Integer> boxedStream = IntStream.range(1, 6)//IntStream
                                               .boxed();  //Stream

        /* 설명. 추후 배울 내용(최종 연산)이지만 컬렉션으로 변환할 때 boxing해보기 */
