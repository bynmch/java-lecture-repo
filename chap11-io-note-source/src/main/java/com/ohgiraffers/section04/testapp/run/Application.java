...
public class Application {
            ...
            * */
            switch (input) {
                ...
                case 4:
                    ...
                    /* 설명. 회원 조회(조회가 되었다고 가정한다.) */
                    Member selectMember = ms.findMemberForMod(chooseMemNo());   //repository의 데이터를 직접 가지고 와서 조작하면 안된다.
                                                                                //기존 회원 사본 객체 반환
        ...
        while(flag) {
            ...
            switch(chooseNo) {
                ...
                case 3:
                    ...
                    modifyMember.setHobbies(resetHobbies());        //배열은 단순 Scanner 입력불가
                    break;
                case 4:
                    System.out.print("수정할 혈액형을 입력하세요(A, AB, B, O): ");
                    modifyMember.setBloodType(resetBloodType());    //enum은 단순 Scanner 입력불가
                    break;
                case 9: 
                    System.out.println("메인 메뉴로 돌아갑니다."); flag = false; break;
                default:
                    System.out.println("번호를 다시 잘 입력하세요.");
    ...
    private static Member signup() {
        ...
        System.out.print("입력할 취미의 개수를 입력하세요(숫자는 1이상): ");
...
/* 필기.
 *  Layered Architecture: 3ta에서 백엔드의 계층을 나눠서 만듦(...-Service-Repository-...)
 *  3-tier-Architecture
* */