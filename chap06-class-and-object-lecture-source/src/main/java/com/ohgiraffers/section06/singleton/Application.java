...
/* 설명.
 *  single pattern이란?
 *   애플리케이션이 시작되고 난 후 어떤 클래스가 최초 한 번만 메모리에 할당되고
 ...
 *   2. 인스턴스가 절대적으로 한 개만 할당 되는 것을 보증할 수 잇다.(feat. 같은 주소)
 *  단점
 *   1. 싱글톤 인스턴스가 너무 많은 일을 하거나 많은 데이터를 공유하면 결합도가 높아져서 병목현상이
 *      유발될 수 있다.
...
/* 설명. hashCode는 다른 객체인데 같은 값이 나오는 경우도 있다. System.identityHashCode사용으로 해결. */
